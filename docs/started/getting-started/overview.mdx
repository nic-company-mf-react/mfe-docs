...
**MultiRepo-MFE-Boilerplate**는 **멀티레포(Multi-repository)** 환경에서 **Module Federation**을 활용하여 구성된 **마이크로 프론트엔드(Micro Frontend, MFE)** 프로젝트입니다.
...
* **공유 타입 패키지**: `@axiom/mfe-lib-shared/types`를 통해 Host와 모든 Remote 앱이 동일한 타입 정의를 공유합니다.
